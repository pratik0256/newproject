...
urlpatterns = [
    ...
    path('admin/employees/<int:employee_id>/update_active_status/', update_employee_active_status, name='update_employee_active_status'),
    path('admin/employees/<int:employee_id>/', get_employee_details, name='get_employee_details'),
